...
--> <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="subject " style="text-align: center">
        <p class="h3" style="color:#C00">Kiểm Tra Trắc Nghiệm môn: Toán</p>
    </div>
    <div class="row">
        <div class="col-12">
            ...
            <form action="" method="post" enctype="multipart/form-data" name="nopBai" id="form1">
                <table class="table table-bordered">
                    <tr style="text-align:left">
                        <td scope="col-2">Kiểm Tra </td>
                        <td scope="col-10">Thường kỳ 15 phút</td>
                    </tr>
                    <tr style="text-align:left">
                        <td scope="col-2">Nội dung</td>
                        <td scope="col-10">Chương 2</td>
                    </tr>
                    <tr style="text-align:left">
                        <td scope="col-2">Khối</td>
                        <td scope="col-10">6</td>
                    </tr>
                    <tr style="text-align:left">
                        <td scope="col-2">Thời Gian Làm Bài</td>
                        <td scope="col-10">00:15:00</td>
                    </tr>
                    <tr style="text-align:left">
                        <td scope="col-2">Ngày Làm</td>
                        <td scope="col-10">2022-04-28 16:16:28</td>
                    </tr>
                    <tr style="text-align:left">
                        <td scope="col-2">Hạn chót</td>
                        <td scope="col-10">2022-04-27 20:16:28</td>
                    </tr>
                    <tr style="text-align:left">
                        <td scope="col-2">Điểm</td>
                        <td scope="col-10">Chưa chấm điểm</td>
                    </tr>
                                        </br>
                </table>
                </form>
                <div class="row">
                    <div class="col-6">
                        <input type="button" class="btn btn-primary" data-toggle="modal" data-target="#xacnhan" name="lambai" style=" float:right; padding:5px; background-color:#096" value="Làm bài">
                        <div class="modal" id="xacnhan">
                        	<div class="modal-dialog-centered" style="width:300px; float:center; align:center; margin-left:600px">
                            <div class="modal-content" >
                                	<div class="modal-body">
                                		<p>Xác nhận thực hiện kiểm tra ngay</p>
                                    </div>
                               		<div class="modal-footer" >
                                    <a class="fcc-btn" href="GDlambaitracnghiem.php" style="background-color:#096; float:right; padding:5px; text-decoration: none; color:#000">Xác nhận</a>
                                    </div>
                                </div>
                            </div>
                         </div>
