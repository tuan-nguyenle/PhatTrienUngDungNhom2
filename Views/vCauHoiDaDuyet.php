<?php
if ($_GET['timeStart'] == '' or $_GET['timeEnd'] == '' or !isset($_GET['lopKiemTra']) or !isset($_GET['hinhThuc']) or !isset($_GET['timeToDo']) or !isset($_GET['txtTenDe'])) {
    echo "<script>alert('Nhập đầy đủ')</script>";
    echo "<meta http-equiv='refresh' content='0;url=index.php?taoBaiKiemTra'>";
    die();
} elseif ($_REQUEST['timeStart'] > $_REQUEST['timeEnd']) {
