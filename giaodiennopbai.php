    ...
    <div class="container-fluid">
        <div id="main">
            ...
            <div class="subject" style="text-align: center">
                <p class="h3" style="color:#C00">Giao động cơ học</p>
            </div>
            <div class="row">
                <div class="col-6">
                    <h4 style="color:#C00">Nộp bài tại đây</h4>
                    <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        <ul class="list--info" style="border: 1px solid green; width:1500px;">
                            <table class="table table-bordered">
                                <thead>
                                    <tr style="text-align:left">
                                        <th scope="col">Đề Kiểm Tra</th>
                                        <th scope="col">fsugfjagfagfjafhjadyhgyuesdyfoshsdjfgiugyehjfhsgyweuryhjasgfuyruahfajfgeautueyraufS</th>
                                    </tr>
                                </thead>
                                ...
                                <thead>
                                    <tr style="text-align:left">
                                        ...
                                        <th scope="col">jhahag</th>
                                    </tr>
                                </thead>
                                <thead>
                                    <tr style="text-align:left">
                                        <th scope="col">Trạng Thái Chấm Điểm</th>
                                        <th scope="col">jhahag</th>
                                    </tr>
                                </thead>
                                <thead>
